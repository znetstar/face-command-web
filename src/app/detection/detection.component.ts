...
export class DetectionComponent implements OnInit {
  constructor(private client: FaceCommandClientService, public snackbar: MatSnackBar, private errors: AppErrorHandler, private zone: NgZone) { 
  ...
  async ngOnInit() {
    ...
    this.client.detectionService.on("StatusChange", (status: Status) => {
      this.zone.run(() => this.lastStatus = status);
    });
